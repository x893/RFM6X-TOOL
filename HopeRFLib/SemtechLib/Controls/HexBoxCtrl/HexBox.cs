			...
			set
			{
				...
				switch (this._borderStyle)
				{
					...
					case BorderStyle.Fixed3D:
						HexBox hexBox1 = this;
						HexBox hexBox2 = this;
						Size border3Dsize1 = SystemInformation.Border3DSize;
						int width;
						int num1 = width = border3Dsize1.Width;
						hexBox2._recBorderRight = width;
						int num2 = num1;
						hexBox1._recBorderLeft = num2;
						HexBox hexBox3 = this;
						HexBox hexBox4 = this;
						Size border3Dsize2 = SystemInformation.Border3DSize;
						int height;
						int num3 = height = border3Dsize2.Height;
						hexBox4._recBorderBottom = height;
						int num4 = num3;
						hexBox3._recBorderTop = num4;
						break;
				}
				this.UpdateRectanglePositioning();
