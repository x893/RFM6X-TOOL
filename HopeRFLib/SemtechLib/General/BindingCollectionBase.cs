...
namespace SemtechLib.General
{
	public abstract class BindingCollectionBase : IBindingList, IList, ICollection, IEnumerable
	{
		...
		event ListChangedEventHandler IBindingList.ListChanged
		{
			add
			{
				BindingCollectionBase bindingCollectionBase = this;
				ListChangedEventHandler changedEventHandler = (ListChangedEventHandler)Delegate.Combine((Delegate)bindingCollectionBase.listChanged, (Delegate)value);
				bindingCollectionBase.listChanged = changedEventHandler;
			}
			remove
			{
				BindingCollectionBase bindingCollectionBase = this;
				ListChangedEventHandler changedEventHandler = (ListChangedEventHandler)Delegate.Remove((Delegate)bindingCollectionBase.listChanged, (Delegate)value);
				bindingCollectionBase.listChanged = changedEventHandler;
			}
		}
