...
namespace SemtechLib.Devices.SX1231.Controls
{
	public class DeviceViewControl : UserControl, INotifyDocumentationChanged
	{
		...
		private void InitializeComponent()
		{
			...
			commonViewControl1.Version = new Version(2, 4);
			...
			transmitterViewControl1.Pa20dBmChanged += new BooleanEventHandler(transmitterViewControl1_Pa20dBmChanged);
			...
			receiverViewControl1.Version = new Version(2, 4);
			...
			packetHandlerView1.Error += new ErrorEventHandler(packetHandlerView1_Error);
			...
			packetHandlerView1.CrcIbmChanged += new BooleanEventHandler(packetHandlerView1_CrcIbmChanged);
			...
			this.Controls.Add(gBoxOperatingMode);
			this.Controls.Add(tabControl1);
			this.Controls.Add(gBoxIrqFlags);
			this.Name = "DeviceViewControl";
			this.Size = new Size(0x3f0, 0x20d);
		...
		private void OnSX1231PropertyChanged(object sender, PropertyChangedEventArgs e)
		{
			switch (e.PropertyName)
			{
				...
				case "Version":
					...
					transmitterViewControl1.Version = sx1231.Version;
				...
				case "Pa20dBm":
					transmitterViewControl1.Pa20dBm = sx1231.Pa20dBm;
					return;
				...
				case "Packet":
					...
					packetHandlerView1.CrcIbmOn = sx1231.Packet.CrcIbmOn;
		...
		private void sx1231_PacketHandlerReceived(object sender, PacketStatusEventArg e)
		{
			if (InvokeRequired)
			{
				BeginInvoke(new SX1231PacketHandlerTransmittedDelegate(OnSX1231PacketHandlerTransmitted), new object[] { sender, e });
			}
			else
			{
		...
		private void sx1231_PropertyChanged(object sender, PropertyChangedEventArgs e)
		{
			if (InvokeRequired)
			{
				BeginInvoke(new SX1231PropertyChangedDelegate(OnSX1231PropertyChanged), new object[] { sender, e });
			}
			else
			{
